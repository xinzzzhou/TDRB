...
from Core.tool.Dataset import DatasetTaobao14
...
def parse_args():
    ...
    parser.add_argument('--dataset', nargs='?', default='taobao2014',
    ...
    parser.add_argument('--regs', nargs='?', default='[0.01,0.001,1]',
    ...
    parser.add_argument('--lr_embed', type=float, default=0.005,
    ...
    parser.add_argument('--len_sequence', type=int, default=4,
...
if __name__ == '__main__':
    ...
    # initialize dataset
    #dataset = DatasetTaobao14(args.path + args.dataset +"/"+ str(args.len_sequence) +"/"+args.dataset+"-" + str(args.len_sequence))
    dataset = DatasetTaobao14(args.path + args.dataset +"/"+ str(args.len_sequence) +"/"+args.dataset)
